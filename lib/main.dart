...
class _MyAppState extends State<MyApp> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(
            title: const Text('NFC basic app'),
            bottom: TabBar(
              tabs: <Widget>[
                Tab(text: 'Leer'),
                Tab(text: 'Escribir'),
                          ...
                          if (_records!.length != 0) {
                            try {
                              ...
                              if (tag.type == NFCTagType.mifare_ultralight ||
                                ...
                                setState(() {
                                  _writeResult = 'Se registro!';
                                });
                              } else {
                                setState(() {
                                  _writeResult =
                                      'error: NDEF no soportado: ${tag.type}';
                                });
                              }
                            } catch (e, stacktrace) {
                              setState(
                            ...
                            setState(() {
                              _writeResult = 'error: No registrado';
                            });
                          }
                        },
                        child: Text("Empezar a escribir"),
                      ),
                      ElevatedButton(
                        onPressed: () {
                          showDialog(
